...
class AuthService {
  ...
  constructor(credentialsRepository: Repository<CredentialsEntity>, sessionRepository: Repository<SessionEntity>) {
  ...
  public async updateCredentials(id: string, credentials: CredentialsInRequest): Promise<CredentialsEntity> {
  ...
  private async getCredentialsByEmailAndHash(email: string, hash: string): Promise<CredentialsEntity> {
